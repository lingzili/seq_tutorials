...
baseFilename=`basename $j Aligned.sortedByCoord.out.bam`
...
Quality metrics are accessed by RNASeQC and Picard.
...
for i in *.bam
do baseFilename=`basename $i Aligned.sortedByCoord.out.bam`
samtools flagstat -@ 32 $i > ${baseFilename}.stat.txt
done 
```
...
outputFile="/data/home/lingzili/Islet_Public_Dataset/Human_bulk_RNA/GSE76268/analysis/featurecount/GSE76268_featureCounts.txt" # Required option for specifying path to, and name of the text output (count matrix)
BAM="/data/home/lingzili/Islet_Public_Dataset/Human_bulk_RNA/GSE76268/analysis/STAR/*.out.bam"
terminalLog="/data/home/lingzili/Islet_Public_Dataset/Human_bulk_RNA/GSE76268/analysis/featurecount/GSE76268_featureCounts.log" # 2> redirects all the information from the terminal/screen into a file

featureCounts -T 32 --verbose -a $GTF -o $outputFile $BAM 2> $terminalLog
